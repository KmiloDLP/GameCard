...
class Combatiente extends NPC {
    ...
    atacar(target) {
        ...
        if (target.EstoyMuerto) { console.error(target.nombre + " a muerto") }
    ...
    habilidadEspecial(target) {
        if (this.MP < 100) {
            ...
            let aumento_atk = target.Atk * 0.4;
            target.Atk += aumento_atk;
            this.MP -= 100;

            console.info(this.nombre + " uso habilidad en ")
            mensaje= target.nombre + " obtiene " + aumento_atk + " puntos de ataque"
...
class Healer extends NPC {
    ...
    atacar(target) {
        if (this.HP <= 0) {
            throw new Error('Estas Muerto')
        }

        let ataque = this.calcularAtaque() - target.Def;
        target.recibirAtaque(ataque);
        console.info(this.nombre + " A ATACADO")
...
class Brujo extends NPC {
    ...
    atacar(target) {
        ...
        let ataque = this.calcularAtaque() - target.Def * 0.9;
        target.recibirAtaque(ataque);
        console.info(this.nombre + " A ATACADO")
            ...
            if (this.isCharacter) {
                switch (accion) {
                    ...
                    case "Habilidad":
                        ...
                        if(equipoPelea[turno].nombre=="Dracnet"){ 
                        ...
                        else{ equipoPelea[turno].habilidadEspecial(equipoPelea[target2])}
...
//arreglos
const NPCs = [
    new Combatiente("Drassus", 3000, 300, 500, 200),
    new Healer("Zoranya", 2000, 400, 100, 500),
    new Tanque("Aincra", 4000, 300, 200, 500),
    new Brujo("Nefura", 2500, 400, 200, 200),
    new Arquero("Dracnet", 2000, 300, 500, 200),
    new Mago("Dreinos", 2500, 400, 200, 200),
];

const assets = [
    new Asset({ x: 200, y: 50, w: 150, h: 200, nombre: "Drassus", imagenURL: "./Img/Avatar/Drassus.png", deadImagenUrl: "./Img/AvatarDeath/DrassusDead.png", infoImageUrl: "./Img/Info/Drassus.png", isCharacter: true }),
    new Asset({ x: 400, y: 50, w: 150, h: 200, nombre: "Zoranya", imagenURL: "./Img/Avatar/Zoranya.png", deadImagenUrl: "./Img/AvatarDeath/ZoranyaDead.png", infoImageUrl: "./Img/Info/Zoranya.png", isCharacter: true }),
    new Asset({ x: 600, y: 50, w: 150, h: 200, nombre: "Aincra", imagenURL: "./Img/Avatar/Aincra.png", deadImagenUrl: "./Img/AvatarDeath/AincraDead.png", infoImageUrl: "./Img/Info/Aincra.png", isCharacter: true }),
    new Asset({ x: 800, y: 50, w: 150, h: 200, nombre: "Nefura", imagenURL: "./Img/Avatar/Nefura.png", deadImagenUrl: "./Img/AvatarDeath/NefuraDead.png", infoImageUrl: "./Img/Info/Nefura.png", isCharacter: true }),
    new Asset({ x: 1000, y: 50, w: 150, h: 200, nombre: "Dracnet", imagenURL: "./Img/Avatar/Dracnet.png", deadImagenUrl: "./Img/AvatarDeath/DracnetDead.png", infoImageUrl: "./Img/Info/Dracnet.png", isCharacter: true }),
    new Asset({ x: 1200, y: 50, w: 150, h: 200, nombre: "Dreinos", imagenURL: "./Img/Avatar/Dreinos.png", deadImagenUrl: "./Img/AvatarDeath/DreinosDead.png", infoImageUrl: "./Img/Info/Dreinos.png", isCharacter: true }),
    ...
    new Asset({//8
        ...
        evento: function () { console.log(this.nombre); this.clicked = true; 
            accion = "Habilidad"; 
    ...
    new Asset({//9
        ...
        evento: function () { console.log(this.nombre);
            MenuObtion();
            this.clicked = true;
        }
    }),
...
function GameStart() { 
    ...
    for(i=0;i<=5;i++){ console.log(assets[i].isShowingStats) ;assets[i].isShowingStats=false; }
